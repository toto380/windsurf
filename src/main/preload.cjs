...
contextBridge.exposeInMainWorld('api', {
  ...
  openReportHTML: (folderPath) => ipcRenderer.invoke('open-report-html', folderPath),
  openReportPDF: (folderPath) => ipcRenderer.invoke('open-report-pdf', folderPath),
  testConnections: (params) => ipcRenderer.invoke('test-connections', params),
  fetchBaseline: (params) => ipcRenderer.invoke('fetch-baseline', params)
});
